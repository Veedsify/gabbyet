                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <p class="mb-4 pl-md-5 line"
                                    data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">A small river named
        ...
        <section class="ftco-intro">
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-md-7 ">
                        <div class="row no-gutters d-flex  align-items-stretch mt-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 half ftco-animate">
                        ...
                        <form action="mailto:gabrieletim2018@gmail.com" class="appointment">
                            <div class="row">
                                <div class="col-md-6">
